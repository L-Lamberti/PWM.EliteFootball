...
async function seedGiocatori() {
  ...
  const giocatori = [
    ...
    ['Cristiano', 'Ronaldo', 40, 'Cristiano Ronaldo è uno dei calciatori più celebri e vincenti della storia, noto per la sua straordinaria forza fisica, tecnica e determinazione. Ha conquistando numerosi titoli nazionali e internazionali tra cui cinque Palloni d’Oro, è anche il miglior marcatore nella storia della Champions League e della nazionale portoghese.', 9.7, 'Cristiano_Ronaldo.jpg'],
